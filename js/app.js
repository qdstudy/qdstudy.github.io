APPS = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "转换工具", url: "https://www.aconvert.com/cn/icon/jpg-to-ico/", icon: "https://www.aconvert.com/favicon.ico" },
      { title: "m3u8 视频下载", 
      ...
      { title: "KMS激活", url: "https://akams.cn/kms/", icon: "https://akams.cn/favicon.png" },
 ...
 * app init
 */
function differenceWithSets(arr1, arr2) {
  const set2 = new Set(arr2);
  return arr1.filter(item => !set2.has(item));
}
let SHOW_APPS = APPS.filter(app => app.flag == true) || [];
let CONTRACT_APPS = differenceWithSets(APPS,SHOW_APPS) || [];
